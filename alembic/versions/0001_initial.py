...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("matched_skills", postgresql.ARRAY(sa.String()), nullable=False, server_default='{}'),
        sa.Column("missing_skills", postgresql.ARRAY(sa.String()), nullable=False, server_default='{}'),
        sa.Column(
            "status",
